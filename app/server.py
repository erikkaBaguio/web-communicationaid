...
@app.route('/clothes_bc')
def clothes_bc():
	return render_template('clothes_bc.html')	

@app.route('/clothes_g')
def clothes_g():
	return render_template('clothes_g.html')

@app.route('/clothes_gc')
def clothes_gc():
	return render_template('clothes_gc.html')	
...
@app.route('/places_c')
def places_c():
	return render_template('places_c.html')	
...
@app.route('/toys_c')
def toys_c():
	return render_template('toys_c.html')
...
@app.route('/food_c')
def food_c():
	return render_template('food_c.html')
